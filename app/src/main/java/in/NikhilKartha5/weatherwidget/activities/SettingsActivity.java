...
import in.NikhilKartha5.weatherwidget.BuildConfig;
import in.NikhilKartha5.weatherwidget.R;
import in.NikhilKartha5.weatherwidget.adapters.SettingsAdapter;
import in.NikhilKartha5.weatherwidget.interfaces.SingleChoiceDialog;
import in.NikhilKartha5.weatherwidget.utils.SettingsItems;
import in.NikhilKartha5.weatherwidget.utils.Utils;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private ArrayList<SettingsItems> getData() {
        ...
        mData.add(new SettingsItems(getString(R.string.app_name) + " " + BuildConfig.VERSION_NAME + " ("
                + BuildConfig.VERSION_CODE + ")", "Copyright: ©2023-2024, NikhilKartha5",
        ...
        mData.add(new SettingsItems(getString(R.string.source_code), getString(R.string.source_code_summary),
                Utils.getDrawable(R.drawable.ic_github, this), "https://github.com/NikhilKartha5/Weather"));
        mData.add(new SettingsItems(getString(R.string.report_issue), getString(R.string.report_issue_summary),
                Utils.getDrawable(R.drawable.ic_issue, this), "https://github.com/NikhilKartha5/Weather/issues/new/choose"));
